...
#[no_mangle]
pub extern fn eval_dcf(key_ptr:*mut c_char, aes_keys_ptr: *mut c_char, alpha: u32, party_id: u8) -> u32 {
...
#[no_mangle]
pub extern fn eval_dpf(key_ptr:*mut c_char, aes_keys_ptr: *mut c_char, alpha: u32, party_id: u8) -> u32 {
    let key_str = my_string_safe(key_ptr);
    let aes_str = my_string_safe(aes_keys_ptr);
